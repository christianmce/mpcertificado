...
<html class="supports-animation supports-columns svg no-touch no-ie no-oldie no-ios supports-backdrop-filter as-mouseuser" lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Tienda Online ChristianMCE</title>
                        ...
                        <div class="pd-billboard pd-category-header">
                            <div class="pd-l-plate-scale">
                                ...
                                <div class="pd-billboard-info">
                                    <h1 class="pd-billboard-header pd-util-compact-small-18">Tienda Online ChristianMCE</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                            ...
                                            <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                                                <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="2|Beats Studio3 Wireless Over‑Ear Headphones - Shadow Gray|MQUF2">
                                                    <div class="as-tilegallery-element as-image-selected">
                                                        <div class=""></div>
                                                        <img style="height:350px;" src="./assets/fundabasket.png" class="ir ir item-image as-producttile-image" alt="" data-desc="Samsung galaxy" >
                                                    </div>
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                            ...
                                            <div class="as-producttile-title">
                                                <h3 class="as-producttile-name">
                                                    <p class="as-producttile-tilelink">
                                                        <span data-ase-truncate="2">Funda Basket para Samsung Galaxy</span>
                                                    </p>
                                        ...
                                        <form action="detail.php" method="get">
                                            <input type="hidden" name="img" value="./assets/fundabasket.png">
                                            <input type="hidden" name="title" value="Funda Basket para Samsung Galaxy">
                                            <input type="hidden" name="price" value="57">
                                            <input type="hidden" name="unit" value="1">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar/Pagar</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="as-producttile large-4 small-6 group-1">
        ...
        <div class="as-footnotes ">
            <div class="as-footnotes-content">
                <div class="as-footnotes-sosumi">
                    Todos los derechos reservados Tienda Tecno 2021 - Christian Mauricio Castillo Estrada
                </div>
            </div>
        </div>
